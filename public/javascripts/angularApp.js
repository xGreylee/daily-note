const app = angular.module('daily-note', ['ui.router', 'ui.bootstrap', 'ngAnimate', 'ngSanitize',
...
app.factory('auth', ['$http', '$window',
	function($http, $window) {
		...
		auth.saveToken = function(token) {
			$window.localStorage['daily-note-token'] = token
		}

		auth.getToken = function() {
			return $window.localStorage['daily-note-token']
		}
		...
		auth.logOut = function() {
			$window.localStorage.removeItem('daily-note-token')
		}
